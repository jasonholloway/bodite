/*
 * CROPPIC (Brigitas Bodite version)
 * dependancy: jQuery
 * author: Ognjen "Zmaj Džedaj" Božičković and Mat Steinlin... and Jason Holloway
 */
...
(function (window, document) {
	...
	Croppic.prototype = {
		...
		{
		    var elForm = $('<form class="' + this.id + '_imgUploadForm">')
                            .css('visibility', 'hidden')
                            .appendTo(this.outputDiv);

		    var elFileInput = $('<input type="file" name="img" />')
			                    .appendTo(elForm);
                        
		    return new Promise(function (fulfilled, rejected) {
		        elFileInput.change(function () {
		            var files = elFileInput[0].files;
